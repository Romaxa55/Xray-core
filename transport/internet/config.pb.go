...
type SocketConfig struct {
	...
	// MegaV addition (2026-05-22): outbound-tag для retry если dial через
	// dialer_proxy fail'нулся на первом Read (handshake). Например, "direct" —
	// тогда после fail chain попробуем dial напрямую (без proxy), replay'я
	// буферизованный первый Write. Пустая строка = поведение как раньше
	// (никакого retry, fail приходит в outbound handler как обычно).
	DialerProxyFallbackTag string `protobuf:"bytes,24,opt,name=dialer_proxy_fallback_tag,json=dialerProxyFallbackTag,proto3" json:"dialer_proxy_fallback_tag,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *SocketConfig) GetDialerProxyFallbackTag() string {
	if x != nil {
		return x.DialerProxyFallbackTag
	}
	return ""
}
...
var file_transport_internet_config_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x84, 0x09, 0x0a, 0x0c, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x64, 0x46, 0x6f, 0x72, 0x12, 0x39, 0x0a, 0x19,
	0x64, 0x69, 0x61, 0x6c, 0x65, 0x72, 0x5f, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x5f, 0x66, 0x61, 0x6c,
	0x6c, 0x62, 0x61, 0x63, 0x6b, 0x5f, 0x74, 0x61, 0x67, 0x18, 0x18, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x16, 0x64, 0x69, 0x61, 0x6c, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x46, 0x61, 0x6c, 0x6c,
	0x62, 0x61, 0x63, 0x6b, 0x54, 0x61, 0x67, 0x22, 0x2f, 0x0a, 0x0a, 0x54, 0x50, 0x72, 0x6f, 0x78,
	...
	,
	...
	,
